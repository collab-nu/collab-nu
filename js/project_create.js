...
function openRole() {
  ...
  newForm.innerHTML = "<input class='newPos' type='text' placeholder='Position name...' /> <input class='btn doneButton' id=but"+ i + " type='button' value='Done' onClick='closeRole(this.id)'>";
